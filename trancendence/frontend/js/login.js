...
class LoginPage {
	...
	render() {
		...
		content.innerHTML = `<div class="ponglogo">
		...
		<form id="loginForm" action="login" method="post" class="form-checkbox-container">
				<div class="inputdiv">
	...
	<div class="authcontainer">
		...
		<button type="submit" id="google-auth-btn" value="googleAuth" class="button2" style="background-color: white;"><img src='../images/google.svg' alt=""></button>
	</div>
	<div class="signUpDiv">
