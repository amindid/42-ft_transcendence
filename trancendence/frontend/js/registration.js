...
export function renderRegistrationPage() {
    ...
    //     const responseMessage = document.createElement('div'); // Added: Create a div for messages
    //     document.getElementById('root').appendChild(responseMessage);

    //     try {
    //         const response = await fetch('http://127.0.0.1:8000/registration/', { // API call
    //             method: 'POST',
    //             headers: {
    //                 'Content-Type': 'application/json',
    //             },
    ...
    //         if (response.ok) {
    //             responseMessage.innerHTML = `<p class="success">${data.success}</p>`; // Success message
    //             responseMessage.style.color = "green";
    //         } else {
    //             responseMessage.innerHTML = `<p class="error">${data.error}</p>`; // Error message
    //             responseMessage.style.color = "red";
    //         }
    //     } catch (error) {
    //         responseMessage.innerHTML = `<p class="error">An error occurred: ${error.message}</p>`; // Catch error
    //         responseMessage.style.color = "red";
    //     }
    // }
